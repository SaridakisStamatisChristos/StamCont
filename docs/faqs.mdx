---
title: "FAQs"
description: "Frequently asked questions for StamCont and inherited Continue-compatible surfaces"
---
<Warning>
This FAQ includes **inherited Continue-compatible UI, configuration, command, and filesystem names** that are still present in StamCont. Those technical names are compatibility surfaces, not repository identity. Upstream Continue distribution/support links should not be treated as StamCont support channels.
</Warning>
...
For StamCont-specific support, create an issue in the [StamCont issue tracker](https://github.com/SaridakisStamatisChristos/StamCont/issues/new).
